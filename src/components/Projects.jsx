    ...
    >
      ...
      >
        ...
        >
          ...
          <p>{t("travelPlannerDescription")}</p>
          <div className="project-stack">
            <span>Next.js</span>
            <span>TypeScript</span>
            <span>Neon</span>
        ...
        >
          <motion.div
            className="project-image"
            style={{ backgroundImage: "url('/projects/whack-a-putin.png')" }}
            whileHover={{ scale: 1.05, transition: { duration: 0.2 } }}
          />
          <a
            href="https://marco-mul.github.io/project-module1/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <h3>Whack-a-Dictator</h3>
          </a>
          <p>{t("whackADictatorDescription")}</p>
          <div className="project-stack">
            <span>HTML</span>
            <span>CSS</span>
